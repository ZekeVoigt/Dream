...
const DetailedView1: React.FC<DetailedView1Props> = ({ handleClose }) => (
      ...
      <div className="flex items-center justify-between mb-10">
        <div className="text-center w-full">
          ...
          <p className="text-neutral-800 mt-2 text-xl">
            Welcome to your products! Here you can "Create a Product" or view
            your Products.
          </p>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell>
                    <div className="font-medium">Marketing 101</div>
